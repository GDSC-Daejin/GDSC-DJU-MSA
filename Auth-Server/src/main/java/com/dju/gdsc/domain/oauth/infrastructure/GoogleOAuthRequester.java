...
public class GoogleOAuthRequester implements OAuthRequester {
    ...
    private String getAccessToken(String code) {
        ...
        //Map<String, Object> responseBody = restTemplate..postForObject(GOOGLE_TOKEN_REQUEST_URL, params, MultivaluedMap.class)
        Map responseBody = new RestTemplate()
                .postForObject(GOOGLE_TOKEN_REQUEST_URL, params, Map.class);
