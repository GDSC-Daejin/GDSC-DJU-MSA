...
@Component
@Slf4j
public class AuthenticationForAdminFilter extends AbstractGatewayFilterFactory<AuthenticationForAllUserFilter.Config> {
    private final AuthTokenProvider authTokenProvider;
    public AuthenticationForAdminFilter(AuthTokenProvider authTokenProvider) {
        super(AuthenticationForAllUserFilter.Config.class);
        this.authTokenProvider = authTokenProvider;
    }

    @Override
    public GatewayFilter apply(AuthenticationForAllUserFilter.Config config) {
